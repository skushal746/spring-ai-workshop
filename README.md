...
```bash
git clone https://github.com/skushal746/spring-ai-workshop.git
...
**Getting Started: Your First AI Application** [`SimpleChatController.java`](src/main/java/dev/skushal746/workshop/SimpleChatController.java)
...
Effective prompting is crucial for getting quality responses from LLMs. Example from [`ArticleController.java`](src/main/java/dev/skushal746/workshop/prompt/ArticleController.java):
...
**Basic Chat Implementation** [`ChatController.java`](src/main/java/dev/skushal746/workshop/chat/ChatController.java):
...
Spring AI automatically converts LLM responses to Java objects [`VacationPlan.java`](src/main/java/dev/skushal746/workshop/output/VacationPlan.java):
...
**Image Analysis** [`ImageDetection.java`](src/main/java/dev/skushal746/workshop/multimodal/image/ImageDetection.java):
...
**Image Generation** [`ImageGeneration.java`](src/main/java/dev/skushal746/workshop/multimodal/image/ImageGeneration.java):
...
Maintain context across requests [`StatefulController.java`](src/main/java/dev/skushal746/workshop/memory/StatefulController.java):
...
**Input Validation Guard** [`InputValidationGuardController.java`](src/main/java/dev/skushal746/workshop/guards/InputValidationGuardController.java):
...
**Fact-Checking Guard** [`FactCheckingGuardController.java`](src/main/java/dev/skushal746/workshop/guards/FactCheckingGuardController.java):
...
Enhance responses with your own data [`ModelsController.java`](src/main/java/dev/skushal746/workshop/rag/ModelsController.java):
...
**RAG Configuration** [`RagConfiguration.java`](src/main/java/dev/skushal746/workshop/rag/RagConfiguration.java):
...
Extend LLM capabilities with custom tools [`WeatherController.java`](src/main/java/dev/skushal746/workshop/tools/weather/WeatherController.java):
...
**DateTime Tools** [`DatTimeTools.java`](src/main/java/dev/skushal746/workshop/tools/datetime/DatTimeTools.java):
...
**Task Management Tools** [`TaskManagementTools.java`](src/main/java/dev/skushal746/workshop/tools/action/TaskManagementTools.java):
...
**Bring Your Own Data** [`ModelComparison.java`](src/main/java/dev/skushal746/workshop/byod/ModelComparison.java):
...
Spring Boot Actuator provides built-in metrics for AI operations. See the [Observability README](src/main/java/dev/skushal746/workshop/observability/README.md) for detailed setup instructions.
...
**Sentiment Analysis Testing** [`SentimentAnalysisTest.java`](src/test/java/dev/skushal746/workshop/evals/SentimentAnalysisTest.java):
...
**Relevancy Evaluation** [`RelevancyEvaluatorTest.java`](src/test/java/dev/skushal746/workshop/evals/RelevancyEvaluatorTest.java):
...
**Fact-Checking Evaluation** [`FactCheckingEvaluatorTest.java`](src/test/java/dev/skushal746/workshop/evals/FactCheckingEvaluatorTest.java):
...
**Structured Output Testing** [`StructuredOutputTest.java`](src/test/java/dev/skushal746/workshop/evals/StructuredOutputTest.java):
...
- [Dan Vega's Newsletter](https://www.skushal746.dev/newsletter)
